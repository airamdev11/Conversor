[33mcommit 9bff1457aa708d31e29794c37929244584a02086[m[33m ([m[1;36mHEAD -> [m[1;32mairam[m[33m, [m[1;31morigin/airam[m[33m)[m
Author: airamdev11 <airamdev11@outlook.com>
Date:   Fri Jun 24 20:18:52 2022 -0500

    primeras modificaciones

[1mdiff --git a/angular.json b/angular.json[m
[1mindex 37762eb..698cede 100644[m
[1m--- a/angular.json[m
[1m+++ b/angular.json[m
[36m@@ -101,5 +101,8 @@[m
         }[m
...
[1mindex e11ca59..f817d00 100644[m
